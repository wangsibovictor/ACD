...
if __name__ == "__main__":
    ...
    p.add_argument("--selectivity", type=float, default=None)
    ...
    if args.selectivity is not None:
        ...
        args.selectivities = "0.02,0.01,0.007,0.005,0.003,0.002,0.001"
        args.efs = "32,64,128,256"
        args.postfilter_pools = "500,1000,2000,4000,8000,16000"
    run(args)
